...
async def help(interaction: discord.Interaction):
  description = '''
</хелп:1076840237860397106> — Показывает это сообщение.
</логи:1076840238099468289> — Включает/Выключает логи на сервере.
</автопубликация:1076840238099468290> — Включает/Выключает автопубликацию новостей на сервере.
</спам активировать:1076840238099468296> — Начинает спам в указанном канале. Также команда может упоминать роль/участника. Могут использовать только люди с правом модерировать участников и упоминать @here с @everyone.
</спам остановить:1076840238099468296> — Останавливает спам в указанном канале.
</снайп:1076840237860397107> — Показывает удалённые сообщения в канале.
</еснайп:1083015735162458152> — Показывает изменённые сообщения.
</бусты:1076840238099468291> — Показывает информацию про бусты.
</генсообщений:1076840237860397111> — Устанавливает канал, где бот будет по умолчанию отвечать на сообщения людей. Могут использовать люди с правом управления сервером.
</лайки:1076840237860397112> — Устанавливает канал для шкалы лайков. В указанном канале под сообщениями/публикациями будут ставиться реакции 👍 и 👎.
</розыгрыши создать:1076840238099468295> — Создаёт розыгрыш.
</розыгрыши закончить:1076840238099468295> — Оканчивает розыгрыш раньше времени.
</розыгрыши удалить:1076840238099468295> — Удаляет розыгрыш.
</розыгрыши список:1076840238099468295> — Показывает список розыгрышей.
</аватар:1076840237860397115> — Показывает аватар участника.
</баннер:1076840237860397114> — Показывает баннер участника.
</токен:1077939372135030856> — Показывает начало токена участника.
</юзеринфо:1076840238099468294> — Выводит информацию об участнике.
</инфо:1076840238099468288> — Показывает информацию о боте.
</кнб:1076840238099468292> — Сыграем в камень-ножницы-бумага?
</iq:1076840237860397108> — Показывает IQ упомянутого человека, или ваш.
</взломжопы:1076840237860397109> — ~~Шуточно~~ взламывает жопу упомянутого человека, или вашу.
</дон:1076840237860397113> — Бот связывается с Рамзаном Кадыровым, чтобы спросить о вас/упомянутом пользователе и понять награждать ли пользователя, или нет.
'''
...
async def spamt(type, method, channel, webhook, ments=None, duration=None):
  if type == "default":
    replics = ["https://media.discordapp.net/attachments/1070339558404788234/1089440482091880458/VID-20230314-WA0004.mp4", "https://media.discordapp.net/attachments/1058665324246999142/1089506643739414588/d1m4ik.stp3d853c.mp4", "https://media.discordapp.net/attachments/1058665324246999142/1087387950918160456/miishuta201377c2bd.mp4", "https://media.discordapp.net/attachments/1058665324246999142/1086629809532174376/VID_20230318_152552_074.mp4", "https://media.discordapp.net/attachments/1058665324246999142/1086636514970173440/VID-20230306-WA0010.mp4", "https://media.discordapp.net/attachments/1084418449029222410/1085491513796075570/what_you_bout_rollin.mp4", "https://media.discordapp.net/attachments/1070339558404788234/1079796724723368036/image-45.png", "https://media.discordapp.net/attachments/1076831393558040626/1076831646168387614/meme.png", "https://media.discordapp.net/attachments/1076831393558040626/1076831646420041758/IMG_20230127_225126.png", "https://media.discordapp.net/attachments/1076831393558040626/1076832319173820436/Polish_20230217_154127364.png", "https://cdn.discordapp.com/attachments/1058665324246999142/1076829118630477914/igorvihorkov2020482a84.mp4", "https://media.discordapp.net/attachments/1076831393558040626/1076832385506746458/Polish_20230129_142317236.jpg", "https://tenor.com/view/%D0%B2%D0%BE%D1%81%D1%81%D1%82%D0%B0%D0%BD%D0%B8%D0%B5%D0%B8%D0%B3%D0%BE%D1%80%D0%B5%D0%B9-%D1%87%D0%B0%D1%82-%D1%87%D0%B0%D1%82%D0%B7%D0%B0%D1%85%D0%B2%D0%B0%D1%87%D0%B5%D0%BD-gif-24861137", "https://cdn.discordapp.com/attachments/1058665324246999142/1076453523547496569/vladimirovich12300f2a10.mp4", "https://media.discordapp.net/attachments/1062616526143889418/1076840315392102410/1674902943175.mp4", "https://media.discordapp.net/attachments/1070339558404788234/1076101998061043752/lv_0_20230217171838.mp4", "https://media.discordapp.net/attachments/1058849734644748310/1086950516564701254/lv_0_20230319155249.mp4"]
  else:
...
async def info_cmd(interaction: discord.Interaction):
  ...
  embed.add_field(name="Программные характеристики", value=f"ОС: Linux\nВерсия Python: {platform.python_version()}\nВерсия discord.py: {discord.__version__}", inline=True)
