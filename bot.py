...
async def spamt(type, method, channel, webhook, ments=None, duration=None):
  if type == "default":
    replics = ["https://youtu.be/1-52IfX_HS4", "https://media.discordapp.net/attachments/1121112898173947955/1127630128080506910/0bf2005b3bb4635ebd75af7ec6b010b1.mp4", "https://media.discordapp.net/attachments/1127984308766920855/1128360315516620880/alex.usticed3ad17.mp4"]
  else:
